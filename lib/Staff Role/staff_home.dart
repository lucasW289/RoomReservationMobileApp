...
import 'package:mobile_app_project/Staff%20Role/staff_browse_room_list.dart';
import 'package:mobile_app_project/Staff%20Role/staff_editingRoom.dart';
import 'package:mobile_app_project/Staff%20Role/staff_history.dart';
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          const RoomBookingScreen(
            role: 'approver',
          ), // Booking Status tab points to the BookingRequestsPage
          StaffHistory(role: 'approver'),
          DashboardScreen(
