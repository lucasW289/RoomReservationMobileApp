...
class LectBrowseRoomList extends StatefulWidget {
  final String role;
  ...
  @override
  _LectBrowseRoomListState createState() => _LectBrowseRoomListState();
}

class _LectBrowseRoomListState extends State<LectBrowseRoomList> {
