...
class StuBrowseRoomList extends StatefulWidget {
  ...
  StuBrowseRoomList({super.key, required this.role, required this.accessToken});
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // First row - Booking Room label and forward arrow
                          const Row(
                            mainAxisAlignment:
                          ...
                          const SizedBox(
                              height: 2), // Add space between the rows
                          // Second row - Room name
                          Text(
                            roomName,
                            style: const TextStyle(
